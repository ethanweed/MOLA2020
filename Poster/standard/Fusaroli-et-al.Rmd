...
```{r fig1, fig.cap = "Factors influencing liklihood of child aligning",message=FALSE, warning = F, out.width='75%'}
...
```{r fig2, fig.cap = "Factors influencing amount of alignment without exact repition", message=FALSE, warning = F, out.width='75%'}
...
```{r fig3, fig.cap = "Factors influencing liklihood of child aligning all tokens", message=FALSE, warning = F, out.width='75%'}
