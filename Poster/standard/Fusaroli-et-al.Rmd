...
# Create a text grob
tgrob <- text_grob(text, face = "plain", color = "black", just = "left")
# Draw the text
#as_ggplot(tgrob)
...
```{r fig1, fig.cap = "Factors predicting the presence or absence of alignment", message=FALSE, warning = F, out.width='80%'}
